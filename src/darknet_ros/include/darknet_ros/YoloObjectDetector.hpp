...
private:
	...
	void cameraCallback_compressed(const sensor_msgs::CompressedImageConstPtr &msg_img_left);
	...
	image_transport::Subscriber imageSubscriber_; //订阅原始图像节点
//    ros::Subscriber imageSubscriber_;  //订阅压缩节点

	ros::Publisher objectPublisher_;
	ros::Publisher boundingBoxesPublisher_;
    image_transport::Publisher bottle_img_pub;
    ros::Publisher bottle_box_pub;
    std_msgs::Header curr_header;  //todo 新一帧更新header
	...
	cv::Mat camImageCopy_dev;
	cv::Mat bottle_img;
	std::vector<std::pair<float, cv::Rect>> Bottle_rects;//--------------------------------------
...
//	bool new_bottles;
	...
	void setupNetwork(char *cfgfile,
					  char *weightfile,
					  char *datafile,
					  float thresh,
					  char **names,
